...
const url 1 = "https://japceibal.github.io/emercado-api/cats_products/101.json";
...
window.onload = loadProducts;
        ...
        const url 2 = 'https://japceibal.github.io/emercado-api/cats_products/101.json';
        ...
        async function loadProducts() {
            try {
                ...
                data.products.forEach(product => {
                    // Clonar la plantilla de producto
                    const productClone = productTemplate.cloneNode(true);
                    productClone.style.display = 'flex'; // Asegurarse de que esté visible
